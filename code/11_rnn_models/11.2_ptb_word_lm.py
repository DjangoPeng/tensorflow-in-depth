...
class PTBModel(object):
  ...
  def __init__(self, is_training, config, input_):
    self._is_training = is_training # 判断该模型是否需要被训练
    self._input = input_ # input_是一个 PTBInput 对象,用于表示模型的输入数据
    ...
    size = config.hidden_size # 模型第一层 RNN 单元中隐藏层神经元的数量,即每个输入单词词向量的长
